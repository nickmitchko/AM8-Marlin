...
//#define STRING_CONFIG_H_AUTHOR "Octávio Maia" // Who made the changes.
#define STRING_CONFIG_H_AUTHOR "Nicholai Mitchko"
 ...
 */
// CHANGE: BAUDRATE was too high, reverting to original
